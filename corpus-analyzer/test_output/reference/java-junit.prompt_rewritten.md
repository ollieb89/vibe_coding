...
This guide provides best practices for writing effective unit tests with JUnit 5, covering both standard and data-driven testing approaches.

## Project Setup

1. Use a standard Maven or Gradle project structure.
2. Place test source code in `src/test/java`.
3. Include dependencies for `junit-jupiter-api`, `junit-jupiter-engine`, and `junit-jupiter-params` for parameterized tests.
4. Use build tool commands to run tests: `mvn test` or `gradle test`.

[source: prompts/java-junit.prompt.md]
