...
## Content Sections
### Triggers
- **Web Search**: Beyond Claude's knowledge cutoff
- **Current Events**: News, updates, and real-time information needs
- **Market Research**: Competitive analysis tasks
...
- **Deep Research Investigations**: Multi-source analysis
...
3. Add a citation [source: plugins/superclaude/mcp/MCP_Tavily.md] at the end
...
[source: plugins/superclaude/mcp/MCP_Tavily.md]