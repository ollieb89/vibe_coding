...
description: Expert in secure backend coding practices specializing in input validation, authentication, and API security. Use PROACTIVELY for backend security implementations or security code reviews. [source: data-validation-suite/agents/backend-security-coder.md]
model: sonnet
---
