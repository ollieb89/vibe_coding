...
# API Design Checklist [source: backend-development/skills/api-design-principles/assets/api-design-checklist.md]

A comprehensive guide to best practices for designing APIs, covering various aspects such as resource design, HTTP methods, status codes, pagination, filtering & sorting, versioning, error handling, authentication & authorization, rate limiting, documentation, testing, security, performance, monitoring, GraphQL-specific checks, and more.
