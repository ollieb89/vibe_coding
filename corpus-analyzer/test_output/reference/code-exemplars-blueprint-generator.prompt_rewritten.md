...
source: prompts/code-exemplars-blueprint-generator.prompt.md
---

## Classification Insights
- Primary Category: reference (confidence: 0.95)
- Secondary Category: architecture (confidence: 0.87)
- Key Features: api_patterns (0.42), code_examples (0.38)
