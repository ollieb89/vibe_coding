...
# SuperClaude Framework - Comprehensive Feature List [source: docs/reference/comprehensive-features.md]

Complete inventory of all features restored in v4.1.9+

## Configuration Options
<!-- Arguments or flags -->
- `--list`: Lists available MCP servers, commands, or resources
- `--dry-run`: Simulates installation without actual execution
